...
\copy stg.rad_data_10 from '/home/user/PostRep/Upscaled_data/new_test_10.csv' delimiter ',' csv header
...
SELECT inData.id AS id,
  ...
  SELECT 	vor.id as id,
    ...
    vor.geom as geom
  FROM proc.voronoi_clip_10 as vor
  LEFT JOIN proc.records_info_10 as rec
